...
router.put('/PutCalendrierRecette', calendrier_recette.PutCalender_Recipe);

router.post('/UpdateCalendrierRecette/:id_calendrier/:id_recette', calendrier_recette.UpdateCalender_Recipe);
