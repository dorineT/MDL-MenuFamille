...
router.post('/PutRecetteCategorie', recette_categories.Put_Recipe_Category);

router.update('/UpdateRecetteCategorie/:id_recette/:id_categorie', recette_categories.Update_Recipe_Category);
